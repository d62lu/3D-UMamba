...
import argparse
import os
from data_utils.DALESBlockDataLoader_v4 import DALESDataset
import torch
import datetime
import logging
...
def main(args):
    ...
    # root = 'data/rs_data/'
    root = root = '../data/DALESObjects/input_0.100/DALES/Block_s20_min4096_norm_enhance/' #rs_40000_m
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        with torch.no_grad():
            ...
            catfile = os.path.join('/lustre04/scratch/dening/dening/DALES/names.txt')
